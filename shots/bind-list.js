...
var P=function(o){return Object.assign({kind:'project',owner:'u1',shared:[],code:'',person:'',phone:'010-6451-5807',
  ...
  options:[],price:0,vat:10,extras:[],costs:[],startedOn:예시날(-20),dueOn:예시날(6),doneOn:null,
  billedOn:null,taxedOn:null,paidOn:null,photos:[],orderPhoto:null,memo:'',arrivals:[],token:null,shareOn:false,
  hiddenOn:null,createdAt:예시날(-20),updatedAt:예시날(-2)},o)};
prjs=[
 P({id:'p1',name:'2027 하드커버 다이어리',client:'블루밍문구',person:'김민수 과장',code:'BL-2708',
    ...
    status:'running',dueOn:예시날(6),price:4800,
    arrivals:[{n:'표지 용지',s:'스노우지 250g',on:예시날(-12)},{n:'내지 용지',s:'모조지 80g',on:예시날(-10)}],
 ...
 P({id:'p2',name:'회사소개 브로슈어',client:'액티바코리아',person:'박지은 대리',code:'AC-0812',
    ...
    bind:'중철',finish:'무광코팅',status:'running',dueOn:예시날(2),price:2200,
    arrivals:[{n:'표지 용지',s:'아트지 200g',on:예시날(-5)},{n:'내지 용지',s:'',on:null}]}),
 P({id:'p3',name:'제품 카탈로그 2026',client:'대한제본',person:'이준호 팀장',code:'DH-0730',
    ...
    bind:'무선',finish:'유광코팅',status:'done',dueOn:예시날(-8),doneOn:예시날(-9),price:3500,
    billedOn:예시날(-8)}),
 P({id:'p4',name:'단어장 (스프링)',client:'한솔제지',person:'정현우 과장',code:'HS-0805',
    ...
    bind:'트윈링',finish:'귀도리',status:'ready',dueOn:예시날(13),price:1600}),
];
allSteps=[
 {id:'s1',projectId:'p1',name:'파일 입고 · 검수',percent:10,at:예시날(-18),note:'',by:'u1',photoPath:null,createdAt:예시날(-18)},
 {id:'s2',projectId:'p1',name:'인쇄',percent:35,at:예시날(-11),note:'표지 4도 완료',by:'u1',photoPath:null,createdAt:예시날(-11)},
 {id:'s3',projectId:'p1',name:'접지',percent:55,at:예시날(-6),note:'',by:'u1',photoPath:null,createdAt:예시날(-6)},
 {id:'s4',projectId:'p1',name:'정합',percent:70,at:예시날(-3),note:'208면 확인',by:'u1',photoPath:null,createdAt:예시날(-3)},
 {id:'s5',projectId:'p2',name:'인쇄',percent:40,at:예시날(-4),note:'',by:'u1',photoPath:null,createdAt:예시날(-4)},
 {id:'s6',projectId:'p3',name:'출고 · 납품',percent:100,at:예시날(-9),note:'500부 전량',by:'u1',photoPath:null,createdAt:예시날(-9)},
];
